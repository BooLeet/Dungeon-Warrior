...
public class SettingsMenuController : MonoBehaviour
{
    ...
    public void LoadGraphicsValues()
    {
        ...
        showFPSToggle.isOn = graphicSettings.showFPS;
    }

    public void ApplyGraphicsSettings()
    {
        GameManager.instance.settings.graphicSettings = new Settings.GraphicSettings(bloomToggle.isOn, filmGrainToggle.isOn, AO_Toggle.isOn, motionBlurToggle.isOn, (byte)resolutionSlider.value, (byte)frameRateSlider.value, showFPSToggle.isOn);
